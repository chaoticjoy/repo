...
function loadRecentUpdates()
{
	...
	for (var dicNow in allPackages) {
		...
		htmlnews +=  "<li class=\"has-icon\"><a href='"+urlOpen+"' target='_blank' role=\"button\"><img style=\"border-radius: 20%;\" src=\"images\/"+encodeURI(allPackages[dicNow].section)+".png\" onerror=\"this.src='images\/Tweak.png'\" alt=\"\"  class=\"icon\"/><label>"+allPackages[dicNow].name+" v"+allPackages[dicNow].version+"</label></a></li>";
	}
